...
VALUES 
	...
	-- insert into room_rate_discount table 	
INSERT INTO `room_rate_discount`(`discount_id`, `discount_rate`, `start_month`, `end_month`, `room_type_room_type_id`)
 VALUES
	...
	(3,15,9,12,3),
	(4,0,4,6,3);
	-- insert into lodge_chain table 	
INSERT INTO `lodge_chain`(`lodge_chain_id`, `lodge_chain_name`, `lodge_chain_contact_number`, `lodge_chain_email_address`, `lodge_chain_website`, `lodge_chain_head_office_address_id`) 
VALUES
	...
	-- insert into lodge table 	
INSERT INTO `lodge`(`lodge_id`, `lodge_name`, `lodge_contact_number`, `lodge_email_address`, `lodge_website`, `lodge_description`, `lodge_floor_count`, `lodge_room_capacity`, `lodge_chain_id`, `addresses_address_id`, `star_ratings_star_rating`, `check_in_time`, `check_out_time`)
	VALUES 
...
INSERT INTO `rooms`(`room_id`, `room_number`, `rooms_type_rooms_type_id`, `lodge_lodge_id`)
 VALUES 
	...
	(34,1134,2,1),
	(35,1135,2,1);
	-- insert into lodge_services table 	
INSERT INTO `lodge_services`(`service_id`, `service_name`, `service_description`, `service_cost`, `lodge_lodge_id`)
 VALUES
...
INSERT INTO `employees`(`emp_id`, `emp_first_name`, `emp_last_name`, `emp_designation`, `emp_contact_number`, `emp_email_address`, `department_department_id`, `addresses_address_id`, `lodge_lodge_id`)
 VALUES 
 ...
 -- insert into lodge_chain_has_lodge table 	
INSERT INTO `lodge_chain_has_lodge`(`lodge_chains_lodge_chain_id`, `lodges_lodge_id`)
 VALUES
 (1,1),
 (1,2),
 (1,3),
...
INSERT INTO `bookings` (`booking_id`, `booking_date`, `duration_of_stay`, `check_in_date`, `check_out_date`, `booking_payment_type`, `total_rooms_booked`, `hotel_hotel_id`, `guests_guest_id`, `employees_emp_id`, `total_amount`)
 VALUES
	...
	-- insert into rooms_booked table 
